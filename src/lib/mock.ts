...
export const STAGE_LABELS: Record<RequestStage, string> = {
  ...
  executive_approved: "بانتظار إنشاء البيان الجمركي",
  customs_released: "صدر البيان الجمركي",
  completed: "مكتمل",
};
...
export const NOTIFICATIONS = [
  ...
  { id: "n4", title: "صدر البيان الجمركي", body: "IMP-2025-1011 – ميناء عدن", time: "اليوم 09:14", unread: false },
...
const EXECUTIVE_BUCKETS: DisplayBucket[] = [
  ...
  { key: "awaiting_customs", label: "بانتظار إنشاء البيان الجمركي", color: C.accent, stages: ["executive_approved"] },
