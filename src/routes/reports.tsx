        ...
        <table className="w-full text-sm min-w-[720px]">
          <thead className="text-xs text-muted-foreground text-right border-b">
            <tr>
              ...
              <th className="py-2.5 sticky left-0 bg-card z-10 shadow-[6px_0_8px_-6px_rgba(0,0,0,0.12)]"></th>
            </tr>
          </thead>
          <tbody>
            {[
              ...
              <tr key={n} className="border-b last:border-0 hover:bg-muted/30">
                ...
                <td className="py-3 sticky left-0 bg-card z-10 shadow-[6px_0_8px_-6px_rgba(0,0,0,0.12)]"><Button size="sm" variant="ghost"><Download className="h-3.5 w-3.5" /></Button></td>
              </tr>
            ))}
          </tbody>
        </table>
