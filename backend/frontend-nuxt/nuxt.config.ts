export default defineNuxtConfig({
  ...
  nitro: {
    devProxy: {
      '/api': {
        target: 'http://yemen-flow-hub.aspx/public',
        changeOrigin: true,
      },
    },
  },
  ...
  runtimeConfig: {
    public: {
      apiBase: process.env.NODE_ENV === 'development' ? '/api' : (process.env.NUXT_PUBLIC_API_BASE || 'http://yemen-flow-hub.aspx/public/api'),
